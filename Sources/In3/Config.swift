...
public struct In3Config : Codable {
    ...
    /// - Parameter debug : if true, debug messages will be written to stderr.
    ...
    /// - Parameter experimental : if true the client allows to use use experimental features, otherwise a exception is thrown if those would be used.
    ...
    public struct Zksync : Codable {
        ...
        /// - Parameter verify_proof_method : rpc-method, which will be used to verify the incomming proof before cosigning.
        /// - Parameter create_proof_method : rpc-method, which will be used to create the proof needed for cosigning.
        public init(provider_url : String? = nil, account : String? = nil, sync_key : String? = nil, main_contract : String? = nil, signer_type : String? = nil, musig_pub_keys : String? = nil, musig_urls : [String]? = nil, create2 : Create2? = nil, verify_proof_method : String, create_proof_method : String) {
            ...
            self.verify_proof_method = verify_proof_method
            self.create_proof_method = create_proof_method
        }
    }
