...
public class Eth {
    ...
    public func getBlockWithTx(blockNumber: UInt64? = nil) -> Future<EthBlockdata?> {
        return execAndConvertOptional(in3: in3, method: "eth_getBlockByNumber", params:blockNumber == nil ? RPCObject("latest") : RPCObject( String(format: "0x%1x", blockNumber!) ),  RPCObject(true), convertWith: { try EthBlockdata($0,$1) } )
    }
    ...
    public func getBlockByHashWithTx(blockHash: String) -> Future<EthBlockdata?> {
        return execAndConvertOptional(in3: in3, method: "eth_getBlockByHash", params:RPCObject( blockHash),  RPCObject(true), convertWith: { try EthBlockdata($0,$1) } )
    }
    ...
    public func getBlockTransactionCountByHash(blockHash: String) -> Future<Int> {
        return execAndConvert(in3: in3, method: "eth_getBlockTransactionCountByHash", params:RPCObject( blockHash), convertWith: toInt )
    }
    ...
    public func getBlockTransactionCountByNumber(blockNumber: UInt64) -> Future<Int> {
        return execAndConvert(in3: in3, method: "eth_getBlockTransactionCountByNumber", params:RPCObject( String(format: "0x%1x", blockNumber)), convertWith: toInt )
    }
    ...
    public func getUncleCountByBlockHash(blockHash: String) -> Future<Int> {
        return execAndConvert(in3: in3, method: "eth_getUncleCountByBlockHash", params:RPCObject( blockHash), convertWith: toInt )
    }
    ...
    public func getUncleCountByBlockNumber(blockNumber: UInt64) -> Future<Int> {
        return execAndConvert(in3: in3, method: "eth_getUncleCountByBlockNumber", params:RPCObject( String(format: "0x%1x", blockNumber)), convertWith: toInt )
    }
    ...
    public func getTransactionCount(account: String, block: UInt64? = nil) -> Future<UInt64> {
        return execAndConvert(in3: in3, method: "eth_getTransactionCount", params:RPCObject( account), block == nil ? RPCObject("latest") : RPCObject( String(format: "0x%1x", block!) ), convertWith: toUInt64 )
    }
